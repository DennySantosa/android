...
public class IncompleteJob extends ListActivity{
	...
	protected void onResume() {
		...
		if(ReusableClass.isConnectingToInternet(IncompleteJob.this))
		{
			//Showing progress dialog 
			pgLogin = new ProgressDialog(IncompleteJob.this);
	...
	private class MyAsyncGetJobs extends AsyncTask<String, Integer, Double>{
		...
		protected void onPostExecute(Double result)
		{
			...
			if(responseBody!= null)
				...
				Toast.makeText(IncompleteJob.this, "No responce from server.", Toast.LENGTH_LONG).show();
		}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) 
	{
		...
		Intent i = new Intent(this, CompleteJobPopUp.class);
