...
public class JobListForEdit extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.job_list_for_edit);
	}
	...
	protected void onResume() {
		...
		if(ReusableClass.isConnectingToInternet(JobListForEdit.this))
		{
			//Showing progress dialog 
			pgLogin = new ProgressDialog(JobListForEdit.this);
	...
	private class MyAsyncGetJobs extends AsyncTask<String, Integer, Double>{
		...
		protected void onPostExecute(Double result)
		{
			...
			if(responseBody!= null)
				...
				Toast.makeText(JobListForEdit.this, "No responce from server.", Toast.LENGTH_LONG).show();
		}
